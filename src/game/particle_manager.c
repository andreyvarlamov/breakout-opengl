...
// Initializes particle object with color = 1.0f
...
void _respawn_particle( size_t i, GameObject* obj, vec2 offset )
{
    // Set position
    // ------------
    ...
    glm_vec2_add( _particles[i].pos, rand_offset, _particles[i].pos );
